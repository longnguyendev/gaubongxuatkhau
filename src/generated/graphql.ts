...
>(
  ...
  useQuery<BlogCategoriesQuery, TError, TData>(
    variables === undefined
      ? ["BlogCategories"]
      : ["BlogCategories", variables],
    fetcher<BlogCategoriesQuery, BlogCategoriesQueryVariables>(
...
useBlogCategoriesQuery.getKey = (variables?: BlogCategoriesQueryVariables) =>
...
>(
  ...
  useInfiniteQuery<BlogCategoriesQuery, TError, TData>(
    variables === undefined
      ? ["BlogCategories.infinite"]
      : ["BlogCategories.infinite", variables],
    (metaData) =>
      fetcher<BlogCategoriesQuery, BlogCategoriesQueryVariables>(
        BlogCategoriesDocument,
...
useInfiniteBlogCategoriesQuery.getKey = (
  variables?: BlogCategoriesQueryVariables
) =>
  variables === undefined
    ? ["BlogCategories.infinite"]
    : ["BlogCategories.infinite", variables];
useBlogCategoriesQuery.fetcher = (variables?: BlogCategoriesQueryVariables) =>
  fetcher<BlogCategoriesQuery, BlogCategoriesQueryVariables>(
    BlogCategoriesDocument,
    variables
  );
export const BlogsDocument = `
  ...
  blogs(pagination: $pagination, filters: $filters, sort: $sort) {
    ...
    ${BlogFragmentDoc}`;
export const useBlogsQuery = <TData = BlogsQuery, TError = unknown>(
...
useBlogsQuery.getKey = (variables?: BlogsQueryVariables) =>
  variables === undefined ? ["Blogs"] : ["Blogs", variables];
export const useInfiniteBlogsQuery = <TData = BlogsQuery, TError = unknown>(
  ...
  useInfiniteQuery<BlogsQuery, TError, TData>(
    variables === undefined
      ? ["Blogs.infinite"]
      : ["Blogs.infinite", variables],
    (metaData) =>
      fetcher<BlogsQuery, BlogsQueryVariables>(BlogsDocument, {
        ...variables,
        ...(metaData.pageParam ?? {}),
      })(),
    options
...
useInfiniteBlogsQuery.getKey = (variables?: BlogsQueryVariables) =>
  variables === undefined ? ["Blogs.infinite"] : ["Blogs.infinite", variables];
useBlogsQuery.fetcher = (variables?: BlogsQueryVariables) =>
  fetcher<BlogsQuery, BlogsQueryVariables>(BlogsDocument, variables);
...
>(
  ...
  useQuery<ProductCategoriesQuery, TError, TData>(
    ...
    fetcher<ProductCategoriesQuery, ProductCategoriesQueryVariables>(
...
>(
  ...
  useInfiniteQuery<ProductCategoriesQuery, TError, TData>(
    variables === undefined
      ? ["ProductCategories.infinite"]
      : ["ProductCategories.infinite", variables],
    (metaData) =>
      fetcher<ProductCategoriesQuery, ProductCategoriesQueryVariables>(
        ProductCategoriesDocument,
        { ...variables, ...(metaData.pageParam ?? {}) }
...
useInfiniteProductCategoriesQuery.getKey = (
  variables?: ProductCategoriesQueryVariables
) =>
  variables === undefined
    ? ["ProductCategories.infinite"]
